...
{	
   ...
   {	
         ...
         FileFilter filter1 = new ExtensionFileFilter("JPG,JPEG", new String[] { "JPG", "JPEG" });
	   ...
	   System.out.println(path);
			...
			try 
			{
				System.out.println("C:\\Windows\\explorer.exe "+folder+img);
			...
			try 
			{
				System.out.println("C:\\Windows\\explorer.exe "+folder+"Encrypted_"+img);
